...
[`ParsedMessage`](/api/transport/src/type-aliases/parsedmessage/)\<`TReq`, `TRes`, `TNotif`\>
...
> **parseMessage**(`data`): [`ParsedMessage`](/api/transport/src/type-aliases/parsedmessage/)\<`TReq`, `TRes`, `TNotif`\>
