...
[`TransportEvents`](/api/transport/src/interfaces/transportevents/).[`connect`](/api/transport/src/interfaces/transportevents/#connect)
...
[`TransportEvents`](/api/transport/src/interfaces/transportevents/).[`data`](/api/transport/src/interfaces/transportevents/#data)
...
[`TransportEvents`](/api/transport/src/interfaces/transportevents/).[`disconnect`](/api/transport/src/interfaces/transportevents/#disconnect)
...
[`TransportEvents`](/api/transport/src/interfaces/transportevents/).[`error`](/api/transport/src/interfaces/transportevents/#error)
