...
> **createStdioChannel**(`executablePath`, `options?`): `Promise`\<[`Channel`](/api/transport/src/interfaces/channel/)\<`unknown`, `unknown`, `unknown`\>\>
...
[`StdioChannelOptions`](/api/transport/src/interfaces/stdiochanneloptions/)
