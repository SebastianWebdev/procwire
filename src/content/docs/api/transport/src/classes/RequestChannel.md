...
[`ChannelOptions`](/api/transport/src/interfaces/channeloptions/)\<`TReq`, `TRes`, `TNotif`\>
...
[`Channel`](/api/transport/src/interfaces/channel/).[`isConnected`](/api/transport/src/interfaces/channel/#isconnected)
...
[`Channel`](/api/transport/src/interfaces/channel/).[`close`](/api/transport/src/interfaces/channel/#close)
...
[`Channel`](/api/transport/src/interfaces/channel/).[`notify`](/api/transport/src/interfaces/channel/#notify)
...
`K` *extends* keyof [`ChannelEvents`](/api/transport/src/interfaces/channelevents/)
...
[`Channel`](/api/transport/src/interfaces/channel/).[`on`](/api/transport/src/interfaces/channel/#on)

***

### onNotification()

> **onNotification**(`handler`): [`Unsubscribe`](/api/transport/src/type-aliases/unsubscribe/)
...
[`NotificationHandler`](/api/transport/src/type-aliases/notificationhandler/)\<`TNotif`\>
...
[`Channel`](/api/transport/src/interfaces/channel/).[`onNotification`](/api/transport/src/interfaces/channel/#onnotification)

***

### onRequest()

> **onRequest**(`handler`): [`Unsubscribe`](/api/transport/src/type-aliases/unsubscribe/)
...
[`RequestHandler`](/api/transport/src/type-aliases/requesthandler/)\<`TReq`, `TRes`\>
...
[`Channel`](/api/transport/src/interfaces/channel/).[`onRequest`](/api/transport/src/interfaces/channel/#onrequest)
...
[`Channel`](/api/transport/src/interfaces/channel/).[`request`](/api/transport/src/interfaces/channel/#request)
...
[`Channel`](/api/transport/src/interfaces/channel/).[`start`](/api/transport/src/interfaces/channel/#start)
