...
> `static` **get**(`name`): [`SerializationCodec`](/api/transport/src/interfaces/serializationcodec/)\<`unknown`\> \| `undefined`
...
[`SerializationCodec`](/api/transport/src/interfaces/serializationcodec/)\<`unknown`\> \| `undefined`
...
> `static` **getByContentType**(`contentType`): [`SerializationCodec`](/api/transport/src/interfaces/serializationcodec/)\<`unknown`\> \| `undefined`
