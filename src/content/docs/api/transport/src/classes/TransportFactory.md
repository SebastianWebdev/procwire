...
> `static` **createOptimal**(`options`): [`Transport`](/api/transport/src/interfaces/transport/)
...
[`StdioTransportOptions`](/api/transport/src/interfaces/stdiotransportoptions/) \| [`SocketTransportOptions`](/api/transport/src/interfaces/sockettransportoptions/) & `object`
...
> `static` **createPipeClient**(`options`): [`Transport`](/api/transport/src/interfaces/transport/)
...
> `static` **createPipeServer**(`options?`): [`TransportServer`](/api/transport/src/interfaces/transportserver/)
...
> `static` **createStdio**(`options`): [`StdioTransport`](/api/transport/src/classes/stdiotransport/)
...
[`StdioTransport`](/api/transport/src/classes/stdiotransport/)
