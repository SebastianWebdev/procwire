...
- `Omit`\<[`SocketTransportOptions`](/api/transport/interfaces/sockettransportoptions/), `"path"`\>
...
[`SocketTransportOptions`](/api/transport/interfaces/sockettransportoptions/).[`autoReconnect`](/api/transport/interfaces/sockettransportoptions/#autoreconnect)
...
[`SocketTransportOptions`](/api/transport/interfaces/sockettransportoptions/).[`connectionTimeout`](/api/transport/interfaces/sockettransportoptions/#connectiontimeout)
...
[`SocketTransportOptions`](/api/transport/interfaces/sockettransportoptions/).[`maxReconnectDelay`](/api/transport/interfaces/sockettransportoptions/#maxreconnectdelay)
...
[`SocketTransportOptions`](/api/transport/interfaces/sockettransportoptions/).[`reconnectDelay`](/api/transport/interfaces/sockettransportoptions/#reconnectdelay)
