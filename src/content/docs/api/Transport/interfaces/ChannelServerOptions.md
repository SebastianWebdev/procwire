...
> **createFraming**: () => [`FramingCodec`](/api/transport/interfaces/framingcodec/)
...
> **createProtocol**: () => [`Protocol`](/api/transport/interfaces/protocol/)\<`TReq`, `TRes`, `TNotif`\>
...
[`Protocol`](/api/transport/interfaces/protocol/)\<`TReq`, `TRes`, `TNotif`\>
...
> **server**: [`TransportServer`](/api/transport/interfaces/transportserver/)
