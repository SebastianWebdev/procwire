...
> `optional` **controlChannel**: [`ChannelConfig`](/api/transport/interfaces/channelconfig/)
...
> `optional` **dataChannel**: [`DataChannelConfig`](/api/transport/interfaces/datachannelconfig/)
...
> `optional` **restartPolicy**: [`RestartPolicy`](/api/transport/interfaces/restartpolicy/)
