...
> **framing**: [`FramingCodec`](/api/transport/interfaces/framingcodec/)
...
> `optional` **middleware**: [`ChannelMiddleware`](/api/transport/interfaces/channelmiddleware/)[]
...
> **protocol**: [`Protocol`](/api/transport/interfaces/protocol/)\<`TReq`, `TRes`, `TNotif`\>
...
> `optional` **responseAccessor**: [`ResponseAccessor`](/api/transport/interfaces/responseaccessor/)
...
> **serialization**: [`SerializationCodec`](/api/transport/interfaces/serializationcodec/)
...
> **transport**: [`Transport`](/api/transport/interfaces/transport/)
