...
> **getHandle**(`id`): [`IProcessHandle`](/api/transport/interfaces/iprocesshandle/) \| `null`
...
[`IProcessHandle`](/api/transport/interfaces/iprocesshandle/) \| `null`

#### Implementation of

[`IProcessManager`](/api/transport/interfaces/iprocessmanager/).[`getHandle`](/api/transport/interfaces/iprocessmanager/#gethandle)
...
[`IProcessManager`](/api/transport/interfaces/iprocessmanager/).[`isRunning`](/api/transport/interfaces/iprocessmanager/#isrunning)
...
`K` *extends* keyof [`ProcessManagerEvents`](/api/transport/interfaces/processmanagerevents/)
...
[`IProcessManager`](/api/transport/interfaces/iprocessmanager/).[`on`](/api/transport/interfaces/iprocessmanager/#on)

***

### spawn()

> **spawn**(`id`, `options`): `Promise`\<[`IProcessHandle`](/api/transport/interfaces/iprocesshandle/)\>
...
`Promise`\<[`IProcessHandle`](/api/transport/interfaces/iprocesshandle/)\>

#### Implementation of

[`IProcessManager`](/api/transport/interfaces/iprocessmanager/).[`spawn`](/api/transport/interfaces/iprocessmanager/#spawn)
...
[`IProcessManager`](/api/transport/interfaces/iprocessmanager/).[`terminate`](/api/transport/interfaces/iprocessmanager/#terminate)
...
[`IProcessManager`](/api/transport/interfaces/iprocessmanager/).[`terminateAll`](/api/transport/interfaces/iprocessmanager/#terminateall)
