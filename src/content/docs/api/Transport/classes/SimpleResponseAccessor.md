...
[`ResponseAccessor`](/api/transport/interfaces/responseaccessor/).[`getError`](/api/transport/interfaces/responseaccessor/#geterror)

***

### getResponseId()

> **getResponseId**(`message`): [`RequestId`](/api/transport/type-aliases/requestid/) \| `undefined`
...
[`RequestId`](/api/transport/type-aliases/requestid/) \| `undefined`

Request ID or undefined if message is not a response

#### Implementation of

[`ResponseAccessor`](/api/transport/interfaces/responseaccessor/).[`getResponseId`](/api/transport/interfaces/responseaccessor/#getresponseid)
...
[`ResponseAccessor`](/api/transport/interfaces/responseaccessor/).[`getResult`](/api/transport/interfaces/responseaccessor/#getresult)
...
[`ResponseAccessor`](/api/transport/interfaces/responseaccessor/).[`isErrorResponse`](/api/transport/interfaces/responseaccessor/#iserrorresponse)
