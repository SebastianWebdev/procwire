...
import type { HeartbeatPingParams, HeartbeatPongParams, ShutdownReason } from "../protocol/reserved-types.js";
 ...
 */
function createReconnectable(handle: ProcessHandle): Reconnectable {
  return {
    connect: async () => {
