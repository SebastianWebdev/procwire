...
`TEventMap` *extends* [`EventMap`](/api/transport/interfaces/eventmap/) = [`EventMap`](/api/transport/interfaces/eventmap/)
...
[`EventHandler`](/api/transport/type-aliases/eventhandler/)\<`TEventMap`\[`K`\]\>
...
> **once**\<`K`\>(`event`, `handler`): [`Unsubscribe`](/api/transport/type-aliases/unsubscribe/)
