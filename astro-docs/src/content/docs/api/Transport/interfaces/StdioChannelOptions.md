...
- `Omit`\<[`StdioTransportOptions`](/api/transport/interfaces/stdiotransportoptions/), `"executablePath"`\>
...
[`StdioTransportOptions`](/api/transport/interfaces/stdiotransportoptions/).[`args`](/api/transport/interfaces/stdiotransportoptions/#args)
...
[`StdioTransportOptions`](/api/transport/interfaces/stdiotransportoptions/).[`cwd`](/api/transport/interfaces/stdiotransportoptions/#cwd)
...
[`StdioTransportOptions`](/api/transport/interfaces/stdiotransportoptions/).[`env`](/api/transport/interfaces/stdiotransportoptions/#env)
...
[`StdioTransportOptions`](/api/transport/interfaces/stdiotransportoptions/).[`maxStderrBuffer`](/api/transport/interfaces/stdiotransportoptions/#maxstderrbuffer)
...
[`StdioTransportOptions`](/api/transport/interfaces/stdiotransportoptions/).[`maxStdoutBuffer`](/api/transport/interfaces/stdiotransportoptions/#maxstdoutbuffer)
...
[`StdioTransportOptions`](/api/transport/interfaces/stdiotransportoptions/).[`startupTimeout`](/api/transport/interfaces/stdiotransportoptions/#startuptimeout)
