...
> `readonly` **controlChannel**: [`Channel`](/api/transport/interfaces/channel/)
...
> `readonly` **dataChannel**: [`Channel`](/api/transport/interfaces/channel/)\<`unknown`, `unknown`, `unknown`\> \| `null`
...
> `readonly` **state**: [`ProcessState`](/api/transport/type-aliases/processstate/)
