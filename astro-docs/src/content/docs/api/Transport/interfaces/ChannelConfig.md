...
> `optional` **framing**: [`FramingCodec`](/api/transport/interfaces/framingcodec/) \| `"line-delimited"` \| `"length-prefixed"`
...
> `optional` **protocol**: `"jsonrpc"` \| `"simple"` \| [`Protocol`](/api/transport/interfaces/protocol/)\<`unknown`, `unknown`, `unknown`\>
...
> `optional` **serialization**: `"json"` \| `"raw"` \| [`SerializationCodec`](/api/transport/interfaces/serializationcodec/)\<`unknown`\>
